  ...
  return (
    <div
      className={cn(
        ...
        isSelected ? "border-primary bg-primary/5 dark:bg-primary/10" : "hover:border-primary/50 hover:bg-muted/50",
      )}
      onClick={() => onSelect(method)}
    >
      <div className="flex h-10 w-10 items-center justify-center">{method.icon}</div>
