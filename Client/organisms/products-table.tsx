...
import { ChevronDown, ChevronUp, MoreHorizontal, Eye, Edit, Copy, Trash, ArrowUpDown } from "lucide-react"
...
const mockProducts = Array.from({ length: 50 }).map((_, i) => ({
  ...
  sku: `SKU-${1000 + i}`,
  category:
    i % 5 === 0 ? "Electronics" : i % 4 === 0 ? "Clothing" : i % 3 === 0 ? "Home" : i % 2 === 0 ? "Books" : "Toys",
  ...
  useEffect(() => {
    ...
    const sortProducts = (a, b) => {
      if (sortBy === "price" || sortBy === "stock") {
        return sortOrder === "asc" ? Number(a[sortBy]) - Number(b[sortBy]) : Number(b[sortBy]) - Number(a[sortBy])
      }
              ...
              <TableRow key={product.id}>
                ...
                <TableCell>
                  <span
                    className={cn(
                      "font-medium",
                      product.stock < 10 ? "text-red-500" : product.stock < 30 ? "text-amber-500" : "",
                    )}
                  >
                    {product.stock}
                  </span>
                ...
                <TableCell className="text-right">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onClick={() => onQuickView && onQuickView(product)}>
                      ...
                      <DropdownMenuItem onClick={() => onDuplicate && onDuplicate(product)}>
