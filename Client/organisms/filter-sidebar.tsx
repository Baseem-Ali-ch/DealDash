...
import { toggleCategory, toggleBrand, setPriceRange, toggleRating, resetFilters } from "@/lib/store/slices/filterSlice"
...
export function FilterSidebar({ isMobile = false, isOpen = false, onClose }: FilterSidebarProps) {
      ...
      <div className="flex-1 overflow-auto p-4">
        <div className="space-y-6">
          ...
          <div>
            ...
            <PriceRangeSlider min={0} max={1000} value={filters.priceRange} onChange={handlePriceRangeChange} />
          </div>

          {/* Ratings */}
          <div>
            <h3 className="mb-3 text-sm font-medium">Ratings</h3>
            <RatingFilter ratings={filters.ratings} onChange={handleRatingToggle} />
          </div>
        </div>
      </div>
