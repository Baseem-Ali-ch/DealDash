  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Please review your order details before placing your order</p>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <div className="space-y-8">
            ...
            <div className="mt-2 rounded-lg border p-4">
              <div className="flex justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm">{shippingMethod.estimatedDelivery}</p>
                </div>
                <p className="font-medium">{shippingMethod.price === 0 ? "Free" : formatPrice(shippingMethod.price)}</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-2 rounded-lg border p-4">
              ...
              {paymentMethod === "credit-card" && <p className="text-sm text-muted-foreground">Ending in •••• 1234</p>}
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <Alert className="mt-6">
            <AlertDescription>
              By clicking "Place Order", you agree to purchase your items and that you have reviewed all the details
              above.
            </AlertDescription>
          </Alert>
        </div>
      ...
      <div className="flex flex-col-reverse sm:flex-row sm:justify-between sm:space-x-2">
        ...
        <Button onClick={handlePlaceOrder} disabled={isSubmitting} className="mt-4 sm:mt-0">
